...
cluster = MongoClient(
  'mongodb+srv://theloveme1238:zx5LtPcgLpcpIh7D@cluster0.pzuhxov.mongodb.net/?retryWrites=true&w=majority'
)
    ...
    for cookies_totel in os.listdir(os.getcwd()):
      ...
      if cookies_totel_1 == 'like':
        ...
        try:
          driver.find_element(
            By.XPATH,
            '/html/body/div[6]/form/fieldset/table/tbody/tr[8]/td/span').click(
            )
        except:
          pass
        time.sleep(10)
        ...
        if current_url == 'https://www.like4like.org/user/':
          ...
          pickle.dump(driver.get_cookies(),
                      open("like_cookies_{}.pkl".format(email), "wb"))
          email_to_find = email
          user_data = collection.find_one({"email": email_to_find})
          new_login_like_1 = 'true_login'
          collection.update_one({"email": email_to_find},
                                {"$set": {
                                  "login_like": new_login_like_1
                                }})
    ...
    for cookies_totel in os.listdir(os.getcwd()):
      ...
      if cookies_totel_1 == 'youtube':
        ...
        if account_true == 'https://www.youtube.com/account' or account_true == 'https://www.youtube.com/account/':
          ...
          collection.update_one({"email": email_to_find},
                                {"$set": {
                                  "login_youtube": new_login_youtube
                                }})
        else:
...
def Subscribe():
  ...
  for s in range(100):
    try:
      ...
      element_control_click = driver.find_element(
        By.CSS_SELECTOR,
        "a[class^='cursor earn_pages_button profile_view_img']")
      ...
      subscribe_button = driver.find_element(
        By.CSS_SELECTOR,
        "div#subscribe-button button span.yt-core-attributed-string").text
      ...
      if subscribe_button == "Subscribe" or subscribe_button == "اشتراك":
        ...
        if sub_new_count == sub_old_count:
          ...
          driver.find_element(
            By.CSS_SELECTOR,
            '[alt="Click On The Button To Confirm Interaction!"]').click()
          ...
          time.sleep(random.randrange(3, 7))
          driver.get(
            "https://www.like4like.org/earn-credits.php?feature=youtubes")
        else:
          print('خطاء')
